...
export default function AboutPage() {
  return (
    ...
    <div className="min-h-screen bg-white font-['DM_Sans',sans-serif]">
      {/* Header/Hero Section */}
      <div className="bg-[#357DF9] py-20 px-6 text-center text-white">
        <h1 className="text-4xl md:text-5xl font-bold mb-4 text-white">About MMGC Healthcare</h1>
      ...
      <div className="max-w-5xl mx-auto py-16 px-6">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="bg-gray-100 rounded-3xl p-8 flex items-center justify-center">
             ...
             <div className="text-[#357DF9] text-6xl font-bold">MMGC</div>
          </div>
        </div>
        ...
        <div className="mt-20 grid sm:grid-cols-3 gap-8">
          <div className="p-6 bg-white border border-gray-100 rounded-2xl shadow-sm">
            ...
            <p className="text-sm text-gray-500">Patient data is encrypted and handled with the highest standards of privacy.</p>
          </div>
          <div className="p-6 bg-white border border-gray-100 rounded-2xl shadow-sm">
            <div className="text-[#357DF9] font-bold text-xl mb-2">Efficiency</div>
            <p className="text-sm text-gray-500">Fast appointment booking and instant access to medical history for doctors.</p>
          </div>
          <div className="p-6 bg-white border border-gray-100 rounded-2xl shadow-sm">
            <div className="text-[#357DF9] font-bold text-xl mb-2">Accessibility</div>
            <p className="text-sm text-gray-500">A user-friendly interface designed for patients of all ages and backgrounds.</p>
          </div>
        </div>

        <div className="mt-20 text-center">
          <Link href="/register" className="bg-[#357DF9] text-white px-8 py-3 rounded-xl font-semibold hover:bg-blue-700 transition-all">
            Join Our Community
          </Link>
        </div>
      </div>
