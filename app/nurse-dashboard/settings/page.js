...
export default function NurseSettings() {
    ...
    const [userRole, setUserRole] = useState("Staff Nurse");
    ...
    useEffect(() => {
        document.title = "Nurse Settings - MMGC";
            ...
            try {
                ...
                if (res.ok) {
                    ...
                    if (data?.name) {
                        ...
                        setUserRole(data.role || "Staff Nurse");
                    }
                }
            } catch (err) {
                console.error("Failed to load nurse profile in Settings:", err);
            }
        }
        fetchUserProfile();
    }, []);
                ...
                <header className="bg-white border-b border-slate-200 px-4 md:px-10 py-6 sticky top-0 z-40 flex justify-between items-center">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-xs md:text-sm text-slate-500 font-semibold mt-0.5">Manage your authentication and preferences</p>
                        </div>
                    </div>
                    
                    {/* Nurse Identity Info Display */}
                    <div className="flex items-center space-x-3 border-l pl-4 border-slate-200">
                        <div className="text-right hidden sm:block">
                            <p className="text-sm font-bold text-slate-800 leading-none">
                                {userName ? userName : "Syncing..."}
                            </p>
