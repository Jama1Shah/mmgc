...
export default function AdminSettings() {
    ...
    useEffect(() => {
        document.title = "Admin Account Settings - MMGC";
        ...
        async function fetchUserProfile() {
            try {
                ...
                console.error("Failed to load admin profile in Settings:", err);
            }
        }
        fetchUserProfile();
    }, []);
                ...
                <header className="bg-white border-b border-slate-200 px-4 md:px-10 py-6 sticky top-0 z-40 flex justify-between items-center">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-xs md:text-sm text-slate-500 font-semibold">Manage your authentication and preferences</p>
                        </div>
                    </div>
                </header>
                    ...
                    <div className="bg-white rounded-3xl border border-slate-200 shadow-sm overflow-hidden flex flex-col">
                        <div className="p-6 md:p-8 border-b border-slate-100 flex items-center gap-3 bg-slate-50/50">
                            ...
                            <div>
                                ...
                                <p className="text-[10px] text-slate-400 font-bold uppercase tracking-widest mt-0.5">Secure your MMGC Admin Account</p>
                            </div>
                        </div>
