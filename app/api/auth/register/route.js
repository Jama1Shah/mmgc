...
export async function POST(req) {
  try {
    ...
    const isVerifiedValue = isVerified !== undefined ? isVerified : false; // Omitted defaults to false for security
    ...
    // If registered via admin and isVerified is true, save directly without sending email
    if (isVerifiedValue) {
