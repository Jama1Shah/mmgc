      ...
      <main className="flex-1 min-w-0">
        ...
        <div className="p-4 md:p-8">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-10 gap-4">
            ...
            <button 
              onClick={() => { setEditingUser(null); setShowPassword(false); setIsVerified(true); setFormRole("Doctor"); setIsModalOpen(true); }}
              ...
              <div className="p-6 md:p-8 space-y-4 md:space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <select name="role" value={formRole} onChange={(e) => setFormRole(e.target.value)} className="w-full p-3 bg-slate-50 border border-slate-100 rounded-xl focus:ring-2 focus:ring-[#357DF9]/20 outline-none text-sm">
