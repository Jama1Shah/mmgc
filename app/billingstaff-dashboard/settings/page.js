...
export default function BillingStaffSettings() {
    ...
    useEffect(() => {
        document.title = "Billing Account Settings - MMGC";
        ...
        async function fetchUserProfile() {
            try {
                ...
                console.error("Failed to load billing staff profile metadata in Settings:", err);
            }
        }
        fetchUserProfile();
    }, []);
