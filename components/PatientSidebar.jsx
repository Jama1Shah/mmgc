...
const PatientSidebar = ({ isOpen, setIsOpen }) => {
  ...
  const navItems = [
    ...
    { icon: <Stethoscope size={20} />, label: "Book Appointment", href: "/patient-dashboard/book-appointment" },
    { icon: <CalendarCheck size={20} />, label: "Appointments", href: "/patient-dashboard/appointments" },
        ...
        <div className="p-6 border-b border-slate-100 flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-[10px] text-slate-400 uppercase tracking-widest font-bold -mt-1">Patient Portal</p>
            </div>
          </div>
